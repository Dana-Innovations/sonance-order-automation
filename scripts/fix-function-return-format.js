...
async function fixFunctionReturnFormat() {
  try {
    console.log('🔧 Fixing Function node return format...\n');
    ...
    console.log('Step 2: Fixing return statement...');

    enrichNode.parameters.functionCode = `// Two-step validation using Function node ($http supported)
...
// IMPORTANT: Return in the format Split expects
return [{ json: { lineItems: lineItems } }];`;
    ...
    console.log('\n✅ SUCCESS! Return format fixed.\n');
    console.log('═══════════════════════════════════════════════════════════');
    console.log('   WHAT WAS WRONG');
    console.log('═══════════════════════════════════════════════════════════\n');

    console.log('BEFORE:');
    console.log('  return [lineItems];  ❌');
    console.log('  Split node got array, not item with lineItems field\n');

    console.log('AFTER:');
    console.log('  return [{ json: { lineItems: lineItems } }];  ✅');
    console.log('  Split node gets proper item structure\n');

    console.log('═══════════════════════════════════════════════════════════');
    console.log('🎯 Test now - Split should work AND mapping should apply!');
    console.log('═══════════════════════════════════════════════════════════\n');
