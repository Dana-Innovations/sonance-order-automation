...
const svgPath = path.join(__dirname, '..', 'public', 'logos', 'sonance-logo.svg');
const pngPath = path.join(__dirname, '..', 'public', 'logos', 'sonance-logo.png');
...
console.log('2. Upload: public/logos/sonance-logo.svg');
console.log('3. Set width to 800px (maintains quality)');
console.log('4. Download and save as: public/logos/sonance-logo.png');
console.log('');
